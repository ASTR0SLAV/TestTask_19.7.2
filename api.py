...
class PetFriends:
    ...
    def add_info_new_pet(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
    ...
    def set_photo_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        ...
        запроса на сервер и результат в формате JSON с данными питомца для которого добавили фото"""
